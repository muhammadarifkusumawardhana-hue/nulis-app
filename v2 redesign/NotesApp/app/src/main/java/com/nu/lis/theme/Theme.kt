...
class AppSettingsState(
    ...
    autoBackupCloud: Boolean = false,
    autoBackupLocal: Boolean = false
) {
    ...
    var autoBackupCloud by mutableStateOf(autoBackupCloud)
    var autoBackupLocal by mutableStateOf(autoBackupLocal)
        ...
        val Saver: Saver<AppSettingsState, *> = listSaver(
            ...
            restore = {
                ...
                AppSettingsState(
                    ...
                    autoBackupCloud = it[16] as Boolean,
                    autoBackupLocal = it[17] as Boolean
                )
            }
        )
    }
